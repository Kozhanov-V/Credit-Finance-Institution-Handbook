...
public class StartupDataLoader implements
    ...
    public void insertIntoCodeValues(){
        ...
        participantStatusRepository.save(new ParticipantStatus("PSAC","«Удаленный», если " +
    ...
    public void insertData(){
        ...
        participantInfo.setNameParticipant("РКЦ БИЙСК");
        participantInfo.setRegionCode("01");
        participantInfo.setIndex("659300");
        participantInfo.setTypeLocation("г");
        participantInfo.setNameLocation("Бийск");
        participantInfo.setAddress("ул. Владимира Ленина, 127");
        participantInfo.setParentBIC(040173001);
        participantInfo.setParticipantType(participantTypeRepository.findByCode(10).get());
        participantInfo.setAvailableTransferService(availableTransferServiceRepository.findByCode(3).get());
        participantInfo.setExchangeParticipant(exchangeParticipantRepository.findByCode(1).get());
        participantInfo.setUID(0147000000);
        ...
        BICDirectoryEntry bicDirectoryEntry = new BICDirectoryEntry(412801030,electronicDocuments,participantInfo);
